...
function NotPlater:HealthOnValueChanged(oldHealthBar, value)
	...
	elseif healthBarConfig.healthText.general.displayType == "both" then
		if(value > 1000000) then
			...
			healthFrame.healthText:SetFormattedText("%.1fm", value/1000000)
		elseif (value > 1000) then
			healthFrame.healthText:SetFormattedText("%.1fk", value/1000)
		else
			healthFrame.healthText:SetFormattedText("%d", value)
		end
